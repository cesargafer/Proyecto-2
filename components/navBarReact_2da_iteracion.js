...
Desempeñando el rol de administrador, necesito tener acceso al menú de comandos, con la finalidad
de consultar información, descargar reportes, configurar líneas de producción y gestionar los
perfiles del sitio.
  ...
  return (
    <div>
      <Nav pills>
        ...
        <NavItem>
          <NavLink href="#">ADMIN</NavLink> {/* Sprint backlog # 1 ID-002  */}
        </NavItem>
      </Nav>
    </div>
  );
